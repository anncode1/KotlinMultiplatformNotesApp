...
import com.anncode.myfirstappmm.domain.note.SearchNotes
...
class NoteListViewModel @Inject constructor(
    ...
    private val searchText = savedStateHandle.getStateFlow("searchText", String())
    ...
    fun onToggleSearch() {
        ...
        if (!isSearchActive.value) {
            savedStateHandle["searchText"] = String()
        }
    }
